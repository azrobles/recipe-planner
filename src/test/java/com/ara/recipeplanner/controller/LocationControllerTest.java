...
class LocationControllerTest {
  ...
  private static final String ENTITY_NAME = "location";
	...
	void indexControllerTest() throws Exception {
		when(service.index()).thenReturn(List.of(new Location()));
	...
	void showControllerTest() throws Exception {
		Long id = 1L;
		when(service.show(id)).thenReturn(new Location(id, "name"));
  ...
  @Test
	void createControllerMethodArgumentNotValidExceptionTest() throws Exception {
		Location entity = new Location(null, null);
  ...
  @Test
    ...
    Long id = 1L;
		Location entity = new Location(id, null);
