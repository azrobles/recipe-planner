...
@WebMvcTest(RecipeTypeController.class)
class RecipeTypeControllerTest {

	private static final String BASE_URL = "/api/recipetypes";
  private static final String ENTITY_NAME = "recipe type";
	...
	void indexControllerTest() throws Exception {
		when(service.index()).thenReturn(List.of(new RecipeType()));
	...
	void showControllerTest() throws Exception {
		Long id = 1L;
		when(service.show(id)).thenReturn(new RecipeType(id, "name"));
  ...
  @Test
	void createControllerMethodArgumentNotValidExceptionTest() throws Exception {
		RecipeType entity = new RecipeType(null, null);
  ...
  @Test
    ...
    Long id = 1L;
		RecipeType entity = new RecipeType(id, null);
