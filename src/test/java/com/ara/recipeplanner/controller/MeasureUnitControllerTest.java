...
class MeasureUnitControllerTest {
	...
	private static final String BASE_URL = "/api/measureunits";
	...
	void indexControllerTest() throws Exception {
		when(service.index()).thenReturn(List.of(new MeasureUnit()));
	...
	void showControllerTest() throws Exception {
		Long id = 1L;
		when(service.show(id)).thenReturn(new MeasureUnit(id, "name"));
  ...
  @Test
	void createControllerEntityDuplicatedExceptionTest() throws Exception {
		...
		String name = "name";
		MeasureUnit entity = new MeasureUnit(id, name);
		String entityName = "measure unit";
  ...
  @Test
	void createControllerMethodArgumentNotValidExceptionTest() throws Exception {
		MeasureUnit entity = new MeasureUnit(null, null);
  ...
  @Test
    ...
    Long id = 1L;
		MeasureUnit entity = new MeasureUnit(id, null);
