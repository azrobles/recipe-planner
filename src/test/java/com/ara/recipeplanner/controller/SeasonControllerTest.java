...
class SeasonControllerTest {
	...
	private static final String BASE_URL = "/api/seasons";
  private static final String ENTITY_NAME = "season";
	...
	void indexControllerTest() throws Exception {
		when(service.index()).thenReturn(List.of(new Season()));
	...
	void showControllerTest() throws Exception {
		Long id = 1L;
		when(service.show(id)).thenReturn(new Season(id, "name"));
  ...
  @Test
	void createControllerMethodArgumentNotValidExceptionTest() throws Exception {
		Season entity = new Season(null, null);
  ...
  @Test
    ...
    Long id = 1L;
		Season entity = new Season(id, null);
